...
export default function Payments() {
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(transaction => 
        ...
        transaction.persons?.toLowerCase().includes(searchTerm.toLowerCase()) ||
        transaction.postedBy?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    if (selectedUser) {
      filtered = filtered.filter(transaction => 
        transaction.postedBy === selectedUser
      );
    }
  ...
  const exportToCSV = () => {
    const headers = ['Amount', 'Date', 'Time', 'Purpose', 'Persons', 'Posted By'];
  ...
  return (
    <div className="max-w-6xl mx-auto pb-16 md:pb-0">
      <h1 className="text-xl font-normal font-raleway text-gray-800 mb-6 hidden md:block">Payment</h1>
      <TransactionNav />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="bg-white rounded shadow p-3">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-xs font-medium text-gray-600">Total Paid In</h3>
                <p className="text-lg font-bold text-gray-800">
                  ${transactions.reduce((sum, transaction) => sum + transaction.amount, 0).toFixed(2)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded shadow p-3">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-xs font-medium text-gray-600">Total Paid Out</h3>
              ...
              <div key={transaction.id} className="border-b border-gray-200 p-4">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-500 mt-1">{transaction.purpose}</div>
                    <div className="text-sm text-gray-700 mt-1">{transaction.persons}</div>
                    <div className="text-xs text-gray-500 mt-1">By: {transaction.postedBy}</div>
